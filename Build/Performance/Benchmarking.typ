...
#title[Benchmarking]
- #a[`test` (unstable)][https://doc.rust-lang.org/beta/unstable-book/library-features/test.html]
- #a[Criterion.rs: Statistics-driven benchmarking library for Rust][https://github.com/bheisler/criterion.rs]
